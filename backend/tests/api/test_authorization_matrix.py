...
ROUTE_ACCESS: dict[str, Access] = {
    ...
    "POST /api/company/me/profile/booklet-page": Access.COMPANY_PROFILE,
    ...
    "POST /api/company/{company_id}/profile/booklet-page": Access.STAFF,
    ...
    "POST /api/kp/bookings/{booking_id}/acknowledge-additions": Access.STAFF,
...
KP_ROUTE_SUBJECT: dict[str, KpSubject] = {
    ...
    "POST /api/kp/bookings/{booking_id}/acknowledge-additions": KpSubject.BOOKINGS,
...
REQUEST_BODIES: dict[str, dict[str, Any]] = {
    ...
    "POST /api/company/me/profile/booklet-page": company_profile_payload(),
    "POST /api/company/{company_id}/profile/booklet-page": company_profile_payload(),
